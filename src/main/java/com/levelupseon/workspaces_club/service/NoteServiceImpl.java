package com.levelupseon.workspaces_club.service;

import com.levelupseon.workspaces_club.dto.NoteDTO;
import com.levelupseon.workspaces_club.entity.Note;
import com.levelupseon.workspaces_club.repository.NoteRepository;
...
public class NoteServiceImpl implements NoteService {
  ...
  public NoteDTO get(Long num) {
    ...
    if(result.isPresent()) {
      return entitiyToDto(result.get());
    }
    return null;
  }
  ...
  public List<NoteDTO> getAllWithWriter(String writerEmail) {
    ...
    return noteList.stream().map(note -> entitiyToDto(note))
